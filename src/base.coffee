...
module.exports = class Model
  ...
  #
  # Create a new document object using your own key by calling `new Model doc, key`. This will use your key for your ODME document which has *doc_type* and *doc_key* in its properties.
  # ```
  ...
  validate_props: () ->
    Joi.validate @props, @props_schema, (err, value) ->
      throw {msg: 'the props field isnt valid', err} if err
      return yes

  validate_doc: () ->
    _.extend @props, {doc_type: Joi.string().required(), doc_key: Joi.string().required()}
    Joi.validate @doc, @props, (err, value) ->
